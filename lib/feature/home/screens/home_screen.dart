    ...
    return Scaffold(
      ...
      appBar: AppBar(
       ...
       /* leading: Padding(
        ...
        title: Image.asset(Images.logo, width: 70),
        actions: [
          ...
          IconButton(
            icon: GetBuilder<NotificationController>(builder: (notificationController) {
              ...
              return Stack(children: [
                ...
                Icon(Icons.notifications_on_outlined, size: 25, color: Theme.of(context).textTheme.bodyLarge!.color),
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                      ...
                      Image.asset(Images.wallet, width: 160, height: 160),
                      ...
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        ) : Container(height: 30, width: 60, color: Colors.black),
              ...
              profileController.profileModel != null ? Container(
                ...
                child: Column(
                  ...
                  Row(mainAxisAlignment: profileController.profileModel!.cashInHands! > 0 && profileController.profileModel!.earnings == 1 ? MainAxisAlignment.spaceBetween : MainAxisAlignment.center, children: [
                    ...
                    (profileController.profileModel!.cashInHands! > 0 && profileController.profileModel!.earnings == 1)
                        ? CustomButtonWidget(
                      width: 110,
                      height: 40,
                      ...
                      margin: EdgeInsets.symmetric(horizontal: 8), // Add margin here
                    )
                        : const SizedBox(),

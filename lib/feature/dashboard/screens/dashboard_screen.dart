        ...
        bottomNavigationBar: GetPlatform.isDesktop ? const SizedBox() : BottomAppBar(
          ...
          child: Padding(
            ...
            child: Row(children: [
              ...
              BottomNavItemWidget(iconData: Icons.home_outlined, isSelected: _pageIndex == 0, onTap: () => _setPage(0)),

              BottomNavItemWidget(iconData: Icons.checklist_rtl_rounded, isSelected: _pageIndex == 1, onTap: () {
                _navigateRequestPage();
              }),

              BottomNavItemWidget(iconData: Icons.shopping_bag_outlined, isSelected: _pageIndex == 2, onTap: () => _setPage(2)),

              BottomNavItemWidget(iconData: Icons.person_2_outlined, isSelected: _pageIndex == 3, onTap: () => _setPage(3)),
